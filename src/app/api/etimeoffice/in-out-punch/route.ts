...
export async function GET(req: NextRequest) {
  try {
    ...
    const fromDate = searchParams.get('FromDate'); // Format: dd/MM/yyyy
    ...
    const response = await fetch(`${apiUrl}/DownloadInOutPunchData?Empcode=${empcode}&FromDate=${fromDate}&ToDate=${toDate}`, {
