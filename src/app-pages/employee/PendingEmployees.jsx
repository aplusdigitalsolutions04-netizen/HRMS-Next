  ...
  return (
    <>
      <style>{`
        ...
        .pe-actions { display:flex; gap:6px; flex-wrap:nowrap; }
        .pe-btn-view { display:inline-flex; align-items:center; gap:5px; padding:7px 14px; background:#fff; color:#6366f1; border:1.5px solid #ddd6fe; border-radius:9px; font-weight:600; font-size:.75rem; text-decoration:none; transition:all .2s; white-space:nowrap; }
        .pe-btn-view:hover { background:#f5f4ff; border-color:#6366f1; transform:translateY(-1px); }
        .pe-btn-approve { display:inline-flex; align-items:center; gap:5px; padding:7px 16px; background:linear-gradient(135deg,#6366f1,#8b5cf6); color:#fff; border:none; border-radius:9px; font-weight:600; font-size:.75rem; cursor:pointer; transition:all .2s; white-space:nowrap; position:relative; overflow:hidden; }
                    ...
                    <td style={{textAlign:'right'}}>
                      <div className="pe-actions" style={{justifyContent:'flex-end'}}>
                        ...
                        <button className="pe-btn-approve" onClick={() => approveEmployee(e.id)} disabled={approvingId === e.id}>
                          {approvingId === e.id ? (
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{animation:'pePulse 1s infinite'}}>
